...
function Export_Doc() {
    ...
    const handleExportjson = async () => {
        try {
            ...
            // Buat URL dengan parameter bulan dan tahun berdasarkan pilihan pengguna
            let url = 'http://localhost:8000/api/v1/document/export-documents-to-json/';
    ...
    const handleExportcsv = async () => {
        try {
            ...
            // Buat URL dengan parameter bulan dan tahun berdasarkan pilihan pengguna
            let url = 'http://localhost:8000/api/v1/document/export-documents-to-csv/';
            if (selectedMonthCsv) {
    ...
    const handleExportexcel = async () => {
        try {
            ...
            // Buat URL dengan parameter bulan dan tahun berdasarkan pilihan pengguna
            let url = 'http://localhost:8000/api/v1/document/export-documents-to-excel/';
