...
const EditProjectInitial = ({ match, handleNextStep }) => {
    ...
    const fetchProjectData = async () => {
      try {
        ...
        setFormData({
          ...
          amount_tax: projectData.amount_tax,
          amount_exc_tax: projectData.amount_exc_tax,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const updatedData = {
        ...
        amount_exc_tax: formData.amount_exc_tax,
...
export default EditProjectInitial;
