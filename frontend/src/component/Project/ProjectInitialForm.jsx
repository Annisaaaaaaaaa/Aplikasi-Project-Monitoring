...
// const ProjectInitialForm = ({ onNextStep, formData, users, clients }) => {
//   const { projectInitial } = formData;
//   const [data, setData] = useState(projectInitial);
...
//     e.preventDefault();
//     onNextStep({ projectInitial: data });
//   };
...
//       <label>
//         PID:
//         <input type="text" name="pid" value={data.pid} onChange={handleInputChange} />
//       </label>
//       <label>
//         TOP (Term of Payment):
//         <input type="text" name="top" value={data.top} onChange={handleInputChange} />
//       </label>
//       <label>
//         Sales:
//         <select name="sales" value={data.sales} onChange={handleInputChange}>
...
//      <label>
//         Customer:
//         <select name="customer" value={data.customer} onChange={handleInputChange}>
...
//       <label>
//         Contract No:
//         <input type="text" name="contract_no" value={data.contract_no} onChange={handleInputChange} />
//       </label>
//       <label>
//         Contract Date:
//         <input type="date" name="contract_date" value={data.contract_date} onChange={handleInputChange} />
//       </label>
//       <label>
//         Amount Exc Tax:
//         <input type="number" name="amount_tax" value={data.amount_tax} onChange={handleInputChange} />
//       </label>
//       <label>
//         Amount Exc Tax:
//         <input type="number" name="amount_exc_tax" value={data.amount_exc_tax} onChange={handleInputChange} />
//       </label>
...
// const ProjectInitialForm = ({ onNextStep, users, clients }) => {
...
//         <label>
//           Name:
//           <input type="text" name="name" value={projectInitial.name} onChange={handleInputChange} />
//         </label>
//         <label>
//           Year:
//           <input type="number" name="year" value={projectInitial.year} onChange={handleInputChange} />
//         </label>
//         <label>
//           PID:
//           <input type="text" name="pid" value={projectInitial.pid} onChange={handleInputChange} />
//         </label>
//         <label>
//           TOP (Term of Payment):
//           <input type="text" name="top" value={projectInitial.top} onChange={handleInputChange} />
//         </label>
//         <label>
//           Sales:
//           <select name="sales" value={projectInitial.sales} onChange={handleInputChange}>
//             <option value="">Select Sales</option>
//             {users.map(user => (
//               <option key={user.id} value={user.id}>{user.email}</option>
//             ))}
...
//         <label>
//           Description:
//           <textarea name="description" value={projectInitial.description} onChange={handleInputChange} />
//         </label>
//       <label>
//           Customer:
//           <select name="customer" value={projectInitial.customer} onChange={handleInputChange}>
//             <option value="">Select Customer</option>
//             {clients.map(client => (
//               <option key={client.id} value={client.id}>{client.name}</option>
//             ))}
...
//         <label>
//           Contract No:
//           <input type="text" name="contract_no" value={projectInitial.contract_no} onChange={handleInputChange} />
//         </label>
//         <label>
//           Contract Date:
//           <input type="date" name="contract_date" value={projectInitial.contract_date} onChange={handleInputChange} />
//         </label>
//         <label>
//           Amount Tax:
//           <input type="number" name="amount_tax" value={projectInitial.amount_tax} onChange={handleInputChange} />
//         </label>
//         <label>
//           Amount Exc Tax:
//           <input type="number" name="amount_exc_tax" value={projectInitial.amount_exc_tax} onChange={handleInputChange} />
//         </label>
