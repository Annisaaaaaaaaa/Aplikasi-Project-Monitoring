...
function Export_Invoice() {
    ...
    const handleExportpdf = async () => {
        try {
            ...
            let url = 'http://localhost:8000/api/v1/invoice/export-invoices-to-pdf/';
            if (selectedMonth) {
    ...
    const handleExportjson = async () => {
        try {
            ...
            // Buat URL dengan parameter bulan dan tahun berdasarkan pilihan pengguna
            let url = 'http://localhost:8000/api/v1/invoice/export-invoices-to-json/';
    ...
    const handleExportcsv = async () => {
        try {
            ...
            // Buat URL dengan parameter bulan dan tahun berdasarkan pilihan pengguna
            let url = 'http://localhost:8000/api/v1/invoice/export-invoices-to-csv/';
            if (selectedMonthCsv) {
    ...
    const handleExportexcel = async () => {
        try {
            ...
            // Buat URL dengan parameter bulan dan tahun berdasarkan pilihan pengguna
            let url = 'http://localhost:8000/api/v1/invoice/export-invoices-to-excel/';
